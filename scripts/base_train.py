...
parser.add_argument("--peri-ln", action="store_true", help="enable Peri-LN: output normalization after each sublayer (Kim et al., ICML 2025)")
parser.add_argument("--diff-attn", action="store_true", help="enable differential attention: noise-cancelling attention via softmax difference (Ye et al., ICLR 2025)")
...
def build_model_meta(depth):
    ...
    config = GPTConfig(
        ...
        window_pattern=args.window_pattern, peri_ln=args.peri_ln, diff_attn=args.diff_attn,
    )
